...
@section('content')
    ...
    <div class="block block-features block-features--layout--classic">
        ...
        <div class="block block-products-carousel" data-layout="grid-4" data-mobile-grid-columns="2">
            <div class="container">
                <div class="block-header">
                    <h3 class="block-header__title">المنتجات المميزة</h3>
        ...
        <div class="block block-banner">
            <div class="container">
                <a href="products.html" class="block-banner__body">
    ...
    <!-- .block-products / end -->
        ...
        <div class="block block-products-carousel" data-layout="horizontal" data-mobile-grid-columns="2">
            <div class="container">
                <div class="block-header">
                    <h3 class="block-header__title">المضاف حديثا</h3>
                    <div class="block-header__divider"></div>
                    <div class="block-header__arrows-list">
                        <button class="block-header__arrow block-header__arrow--left" type="button">
                            <i class="fa fa-arrow-left" width="7px" height="11px"></i>
                ...
                <div class="block-products-carousel__slider">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(1122px, 0px, 0px); transition: all 0s ease 0s; width: 4490px; padding-left: 1px; padding-right: 1px;"><div class="owl-item cloned" style="width: 360px; margin-left: 14px;"><div class="block-products-carousel__column" data-category="">
                                <div class="block-products-carousel__cell">
                                    <div class="product-card product-card--hidden-actions ">
                                        <div class="product-card__badges-list">
                                        </div>
                                        <div class="product-card__image product-image">
                                            <a href="/products/16736" class="product-image__body">
                                                <img class="product-image__img" alt="" src="images/products/8.jpg">
                                            </a>
                                        </div>
                                        <div class="product-card__info">
                                            <div class="product-card__name">
                                                <a href="/products/16736">سليبرز صبايا مميز</a>
                                            </div>
                                            <div class="product-card__rating">
                                                <div class="product-card__rating-stars">
                                                    <div class="rating">
                                        ...
                                        <div class="product-card__actions">
                                            ...
                                            <div class="product-card__prices" style="margin-top: -40px;">
                                                                                                    40₪
                                                                                            </div>
                                            <div class="product-card__buttons">
                                                <a class="btn btn-primary product-card__addtocart" href="/products/16736">الذهاب
                                                    للمنتج</a>
                                                <button class="btn btn-secondary product-card__addtocart product-card__addtocart--list" type="button">الذهاب للمنتج
                                                </button>
                                        ...
                                        <div class="product-card product-card--hidden-actions ">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="/products/16737" class="product-image__body">
                                                    <img class="product-image__img" alt="" src="images/products/9.jpg">
                                                </a>
                                            </div>
                                            <div class="product-card__info">
                                                <div class="product-card__name">
                                                    <a href="/products/16737">بوت صبايا ابيض مميز</a>
                                                </div>
                                                <div class="product-card__rating">
                                                    <div class="product-card__rating-stars">
                                                        <div class="rating">
                                            ...
                                            <div class="product-card__actions">
                                                ...
                                                <div class="product-card__buttons">
                                                    <a class="btn btn-primary product-card__addtocart" href="/products/16737">الذهاب
                                                        للمنتج</a>
                                                    <button class="btn btn-secondary product-card__addtocart product-card__addtocart--list" type="button">الذهاب للمنتج
                                                    </button>
                                                    <button class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__wishlist" type="button">
                                                        ...
                                                        <span class="fake-svg-icon fake-svg-icon--wishlist-16"></span>
                                                            ...
                                                            </div></div><div class="owl-item cloned" style="width: 360px; margin-left: 14px;"><div class="block-products-carousel__column" data-category="">
                                <div class="block-products-carousel__cell">
                                    <div class="product-card product-card--hidden-actions ">
                                        <div class="product-card__badges-list">
                                        </div>
                                        <div class="product-card__image product-image">
                                            <a href="/products/16738" class="product-image__body">
                                                <img class="product-image__img" alt="" src="images/products/10.jpg">
                                            </a>
                                        </div>
                                        <div class="product-card__info">
                                            <div class="product-card__name">
                                                <a href="/products/16738">بوت صبايا راقي</a>
                                            </div>
                                            <div class="product-card__rating">
                                                <div class="product-card__rating-stars">
                                                    <div class="rating">
                                        ...
                                        <div class="product-card__actions">
                                            ...
                                            <div class="product-card__buttons">
                                                <a class="btn btn-primary product-card__addtocart" href="/products/16738">الذهاب
                                                    للمنتج</a>
                                                <button class="btn btn-secondary product-card__addtocart product-card__addtocart--list" type="button">الذهاب للمنتج
                                                </button>
                                                <button class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__wishlist" type="button">
                                        ...
                                        <div class="product-card product-card--hidden-actions ">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="/products/16739" class="product-image__body">
                                                    <img class="product-image__img" alt="" src="images/products/1.jpg">
                                                </a>
                                            </div>
                                            <div class="product-card__info">
                                                <div class="product-card__name">
                                                    <a href="/products/16739">حذاء نسائي بكعب عريض</a>
                                                </div>
                                                <div class="product-card__rating">
                                                    <div class="product-card__rating-stars">
                                                        <div class="rating">
                                            ...
                                            <div class="product-card__actions">
                                                ...
                                                <div class="product-card__buttons">
                                                    <a class="btn btn-primary product-card__addtocart" href="/products/16739">الذهاب
                                                        للمنتج</a>
                                                    <button class="btn btn-secondary product-card__addtocart product-card__addtocart--list" type="button">الذهاب للمنتج
                                                    </button>
                                                    <button class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__wishlist" type="button">
                                ...
                                <div class="block-products-carousel__cell">
                                    <div class="product-card product-card--hidden-actions ">
                                        ...
                                        <div class="product-card__image product-image">
                                            <a href="/products/16740" class="product-image__body">
                                                <img class="product-image__img" alt="" src="images/products/6.jpg">
                                            </a>
                                        </div>
                                        <div class="product-card__info">
                                            <div class="product-card__name">
                                                <a href="/products/16740">حذاء نسائي بكعب عريض</a>
                                            </div>
                                            <div class="product-card__rating">
                                                <div class="product-card__rating-stars">
                                                    <div class="rating">
                                        ...
                                        <div class="product-card__actions">
                                            ...
                                            <div class="product-card__buttons">
                                                <a class="btn btn-primary product-card__addtocart" href="/products/16740">الذهاب
                                                    للمنتج</a>
                                                <button class="btn btn-secondary product-card__addtocart product-card__addtocart--list" type="button">الذهاب للمنتج
                                                </button>
                                                <button class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__wishlist" type="button">
                                        ...
                                        <div class="product-card product-card--hidden-actions ">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="/products/16741" class="product-image__body">
                                                    <img class="product-image__img" alt="" src="images/products/3.jpg">
                                                </a>
                                            </div>
                                            <div class="product-card__info">
                                                <div class="product-card__name">
                                                    <a href="/products/16741">شبشب صبايا ناعم</a>
                                                </div>
                                                <div class="product-card__rating">
                                                    <div class="product-card__rating-stars">
                                                        <div class="rating">
                                            ...
                                            <div class="product-card__actions">
                                                ...
                                                <div class="product-card__buttons">
                                                    <a class="btn btn-primary product-card__addtocart" href="/products/16741">الذهاب
                                                        للمنتج</a>
                                                    <button class="btn btn-secondary product-card__addtocart product-card__addtocart--list" type="button">الذهاب للمنتج
                                                    </button>
                                                    <button class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__wishlist" type="button">
                                                        ...
                                                        <span class="fake-svg-icon fake-svg-icon--wishlist-16"></span>
                                                            ...
                                                            </div></div><div class="owl-item active" style="width: 360px; margin-left: 14px;"><div class="block-products-carousel__column" data-category="">
                                <div class="block-products-carousel__cell">
                                    <div class="product-card product-card--hidden-actions ">
                                        <div class="product-card__badges-list">
                                        </div>
                                        <div class="product-card__image product-image">
                                            <a href="/products/16730" class="product-image__body">
                                                <img class="product-image__img" alt="" src="images/products/5.jpg">
                                            </a>
                                        </div>
                                        <div class="product-card__info">
                                            <div class="product-card__name">
                                                <a href="/products/16730">حذاء نسائي فرو من الداخل</a>
                                            </div>
                                            <div class="product-card__rating">
                                                <div class="product-card__rating-stars">
                                                    <div class="rating">
                                        ...
                                        <div class="product-card__actions">
                                            ...
                                            <div class="product-card__buttons">
                                                <a class="btn btn-primary product-card__addtocart" href="/products/16730">الذهاب
                                                    للمنتج</a>
                                                <button class="btn btn-secondary product-card__addtocart product-card__addtocart--list" type="button">الذهاب للمنتج
                                                </button>
                                                <button class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__wishlist" type="button">
                                        ...
                                        <div class="product-card product-card--hidden-actions ">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="/products/16731" class="product-image__body">
                                                    <img class="product-image__img" alt="" src="images/products/6.jpg">
                                                </a>
                                            </div>
                                            <div class="product-card__info">
                                                <div class="product-card__name">
                                                    <a href="/products/16731">منتوفلي صبايا مميز</a>
                                                </div>
                                                <div class="product-card__rating">
                                                    <div class="product-card__rating-stars">
                                                        <div class="rating">
                                            ...
                                            <div class="product-card__actions">
                                                ...
                                                <div class="product-card__buttons">
                                                    <a class="btn btn-primary product-card__addtocart" href="/products/16731">الذهاب
                                                        للمنتج</a>
                                                    <button class="btn btn-secondary product-card__addtocart product-card__addtocart--list" type="button">الذهاب للمنتج
                                                    </button>
                                                    <button class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__wishlist" type="button">
                                ...
                                <div class="block-products-carousel__cell">
                                    <div class="product-card product-card--hidden-actions ">
                                        ...
                                        <div class="product-card__image product-image">
                                            <a href="/products/16732" class="product-image__body">
                                                <img class="product-image__img" alt="" src="images/products/1.jpg">
                                            </a>
                                        </div>
                                        <div class="product-card__info">
                                            <div class="product-card__name">
                                                <a href="/products/16732">حذاء صبايا برقبة مميز</a>
                                            </div>
                                            <div class="product-card__rating">
                                                <div class="product-card__rating-stars">
                                                    <div class="rating">
                                        ...
                                        <div class="product-card__actions">
                                            ...
                                            <div class="product-card__buttons">
                                                <a class="btn btn-primary product-card__addtocart" href="/products/16732">الذهاب
                                                    للمنتج</a>
                                                <button class="btn btn-secondary product-card__addtocart product-card__addtocart--list" type="button">الذهاب للمنتج
                                                </button>
                                                <button class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__wishlist" type="button">
                                        ...
                                        <div class="product-card product-card--hidden-actions ">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="/products/16733" class="product-image__body">
                                                    <img class="product-image__img" alt="" src="images/products/2.jpg">
                                                </a>
                                            </div>
                                            <div class="product-card__info">
                                                <div class="product-card__name">
                                                    <a href="/products/16733">بنطلون نسائي جينز كاجوال</a>
                                                </div>
                                                <div class="product-card__rating">
                                                    <div class="product-card__rating-stars">
                                                        <div class="rating">
                                            ...
                                            <div class="product-card__actions">
                                                ...
                                                <div class="product-card__buttons">
                                                    <a class="btn btn-primary product-card__addtocart" href="/products/16733">الذهاب
                                                        للمنتج</a>
                                                    <button class="btn btn-secondary product-card__addtocart product-card__addtocart--list" type="button">الذهاب للمنتج
                                                    </button>
                                                    <button class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__wishlist" type="button">
                                ...
                                <div class="block-products-carousel__cell">
                                    <div class="product-card product-card--hidden-actions ">
                                        ...
                                        <div class="product-card__image product-image">
                                            <a href="/products/16734" class="product-image__body">
                                                <img class="product-image__img" alt="" src="images/products/3.jpg">
                                            </a>
                                        </div>
                                        <div class="product-card__info">
                                            <div class="product-card__name">
                                                <a href="/products/16734">تي شيرت شبابي ناعمة</a>
                                            </div>
                                            <div class="product-card__rating">
                                                <div class="product-card__rating-stars">
                                                    <div class="rating">
                                        ...
                                        <div class="product-card__actions">
                                            ...
                                            <div class="product-card__buttons">
                                                <a class="btn btn-primary product-card__addtocart" href="/products/16734">الذهاب
                                                    للمنتج</a>
                                                <button class="btn btn-secondary product-card__addtocart product-card__addtocart--list" type="button">الذهاب للمنتج
                                                </button>
                                                <button class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__wishlist" type="button">
                                        ...
                                        <div class="product-card product-card--hidden-actions ">
                                            ...
                                            <div class="product-card__image product-image">
                                                <a href="/products/16735" class="product-image__body">
                                                    <img class="product-image__img" alt="" src="images/products/4.jpg">
                                                </a>
                                            </div>
                                            <div class="product-card__info">
                                                <div class="product-card__name">
                                                    <a href="/products/16735">حذاء نسائي شتوي</a>
                                                </div>
                                                <div class="product-card__rating">
                                                    <div class="product-card__rating-stars">
                                                        <div class="rating">
                                            ...
                                            <div class="product-card__actions">
                                                ...
                                                <div class="product-card__buttons">
                                                    <a class="btn btn-primary product-card__addtocart" href="/products/16735">الذهاب
                                                        للمنتج</a>
                                                    <button class="btn btn-secondary product-card__addtocart product-card__addtocart--list" type="button">الذهاب للمنتج
                                                    </button>
                                                    <button class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__wishlist" type="button">
                                                ...
                                                <div class="product-card__buttons">
                                                    ...
                                                    <button class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__wishlist" type="button">
                                                        ...
                                                        <span class="fake-svg-icon fake-svg-icon--wishlist-16"></span>
                                                            ...
                                                            </div></div><div class="owl-item" style="width: 360px; margin-left: 14px;"><div class="block-products-carousel__column" data-category="">
                                <div class="block-products-carousel__cell">
                                    <div class="product-card product-card--hidden-actions ">
                                        <div class="product-card__badges-list">
                                        </div>
